def turn_one_bot_2(hand):
    ...
    for i, j in enumerate(hand):
        if j in range(13):
            count_hearts +=1
            if count_hearts == 2 and (hand[0]%13)+2 > 9 or count_hearts == 2 and (hand[1]%13)+2 > 7:
                return 1

        if j in range(13,26):
            count_diamonds +=1
            if count_diamonds == 2 and (hand[0]%13)+2 > 9 or count_diamonds == 2 and (hand[1]%13)+2 > 7:
                return 1
            
        if j in range(26,39):
            count_spades +=1
            if count_spades == 2 and (hand[0]%13)+2 > 9 or count_spades == 2 and (hand[1]%13)+2 > 7:
                return 1
            
        if j in range(39,52):
            count_clubs +=1
            if count_clubs == 2 and (hand[0]%13)+2 > 9 or count_clubs == 2 and (hand[1]%13)+2 > 7:
                return 1
        
        #if it has an ace, king or queen it bets
        if j in range(11,13) or j in range(24,26) or j in range(37,39) or j in range(50,52):
            return 1
        ...
        for t in range(len(hand)-1):
            if j+count_cards_in_a_row in hand or j+count_cards_in_a_row+13 in hand or j+count_cards_in_a_row+26 in hand or j+count_cards_in_a_row+39 in hand or j+count_cards_in_a_row-13 in hand or j+count_cards_in_a_row-26 in hand or j+count_cards_in_a_row-39 in hand:
                count_cards_in_a_row += 1
                if count_cards_in_a_row >= 2 and hand[0]%13+2 > 7:
...
def turn_two_bot_2(hand, ai_has_betted):
...
def turn_three_bot_2(hand, ai_has_betted):
    ...
    for i in range(13):
        if ((i in hand) and (i + 13 in hand)
            ...
            or (i + 26 in hand) and (i + 39 in hand)): 
            hand_of_pairs += 1
    if hand_of_pairs >=1 and i%13+2 > 6:
        return 1
...
def turn_four_bot_2(hand, ai_has_betted):
    #if the bot has two pair, its gonna bet
    hand = sorted(hand)
    hand_of_pairs = 0    
    for i in range(13):
        if ((i in hand) and (i + 13 in hand)
            ...
            or (i + 26 in hand) and (i + 39 in hand)): 
            hand_of_pairs += 1
    if hand_of_pairs >=1 and i%13+2 > 8:
        return 1
...
if __name__ == "__main__":
    cards = [3, 21, 29, 14, 13, 12, 10]
    print(turn_four_bot_2(cards, False))
