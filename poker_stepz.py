...
class MasterGame:
    ...
    def turn_one_part_two(self, ai_action):        
        ...
        if self.round % 2 != 0: 
            ...
            act_bot = turn_one_bot(self.bot_hand)
            if act_bot == 1:
                self.bot -= 1
                self.table_amount += 1
                ##print('self.bot has betted 1 point\n')
        ...
        if self.round % 2 == 0:
            # act_bot = actions('self.bot',self.ai_has_betted)
            act_bot = turn_two_bot(self.game.merge_bot_and_table(), self.ai_has_betted)
            if act_bot == 1:
                self.bot -= 1
                self.table_amount += 1
                self.bot_has_betted = True
    ...
    def turn_two_part_one(self, ai_action):
        ...
        if self.round % 2 == 0:
            # act_bot = actions('self.bot',self.ai_has_betted)
            act_bot = turn_three_bot(self.game.merge_bot_and_table(), self.ai_has_betted)
            if act_bot == 1:
                self.bot -= 1
                self.table_amount += 1
                self.bot_has_betted = True
    ...
    def turn_three_part_one(self, ai_action):
        ...
        if self.round % 2 == 0:
            # act_bot = actions('self.bot',self.ai_has_betted)
            act_bot = turn_four_bot(self.game.merge_bot_and_table(), self.ai_has_betted)
            if act_bot == 1:
                self.bot -= 1
                self.table_amount += 1
                self.bot_has_betted = True
